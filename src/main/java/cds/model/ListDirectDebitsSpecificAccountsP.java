...
public class ListDirectDebitsSpecificAccountsP {
    ...
    public ListDirectDebitsSpecificAccountsP() {

    }

    public ListDirectDebitsSpecificAccountsP(RequestAccountIds accountIds,int page,int pageSize,String xV,String xMinV,String xFapiInteractionId,String xFapiAuthDate,String xFapiCustomerIpAddress,String xCdsUserAgent,String xCdsSubject) {
