...
public class ListBalancesSpecificAccountsP {
    ...
    public ListBalancesSpecificAccountsP(RequestAccountIds accountIds,int page,int pageSize,String xV,String xMinV,String xFapiInteractionId,String xFapiAuthDate,String xFapiCustomerIpAddress,String xCdsUserAgent,String xCdsSubject) {
