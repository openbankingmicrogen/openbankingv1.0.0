...
public class GetCustomerDetailP {
    ...
    public GetCustomerDetailP() {

    }

    public GetCustomerDetailP(String xV,String xMinV,String xFapiInteractionId,String xFapiAuthDate,String xFapiCustomerIpAddress,String xCdsUserAgent,String xCdsSubject) {
        this.xV = xV;
        this.xMinV = xMinV;
