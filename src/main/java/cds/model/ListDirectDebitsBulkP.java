...
public class ListDirectDebitsBulkP {
    ...
    public ListDirectDebitsBulkP() {

    }

    public ListDirectDebitsBulkP(String productCategory,String openStatus,Boolean isOwned,int page,int pageSize,String xV,String xMinV,String xFapiInteractionId,String xFapiAuthDate,String xFapiCustomerIpAddress,String xCdsUserAgent,String xCdsSubject) {
